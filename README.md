...
assets/js/app.js         # scroll reveal, nav, reduced-motion gating
assets/docs/             # résumé (PDF)
```

## Roadmap

- [ ] Fill `[PLACEHOLDER]` impact metrics in Experience
- [ ] Replace draft Engineering Philosophy notes with own words
- [ ] Confirm which Architect/AI badges to publish as earned
